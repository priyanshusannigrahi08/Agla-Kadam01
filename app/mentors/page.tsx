    ...
    <main className="min-h-screen bg-paper text-ink">
      <div className="mx-auto max-w-5xl px-6 py-16 sm:py-24">
        ...
        <p className="mb-8 max-w-lg text-ink/70">
          Search by name or what someone knows. Book directly and start a conversation with someone who has walked a similar path.
        </p>
        ...
        {!loading && !error && filtered.length === 0 && (
          <div className="pin-shadow max-w-xl rounded-sm border border-ink/10 bg-white p-8">
            <p className="font-body text-ink/70">No mentors match your search. Try another term or check back soon.</p>
          </div>
        )}
