...
import { ArrowRight, CheckCircle2, Circle, LayoutDashboard, Plus, Sparkles, Trash2 } from "lucide-react";
...
export default function ConversationPage() {
  const params = useParams<{ "booking-id": string }>();
  ...
  const completedCount = useMemo(() => actions.filter(action => action.completed).length, [actions]);
