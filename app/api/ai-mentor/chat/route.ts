...
Keep answers concise unless the user asks for a detailed plan.`;
    ...
    // Using the "-latest" alias rather than a pinned dated snapshot
    // (e.g. "gemini-2.5-flash") — Google has an open, acknowledged issue
    // where some pinned snapshots return 404 on generateContent even
    // though they show up as available in ListModels. The alias routes
    // around that.
