...
import { ArrowRight, CheckCircle2, Circle, Compass, Map as MapIcon, Sparkles } from "lucide-react";
...
export default function CareerMapPage() {
  ...
  const mentorMap = useMemo(() => new globalThis.Map(mentors.map(m => [m.id, m])), [mentors]);
